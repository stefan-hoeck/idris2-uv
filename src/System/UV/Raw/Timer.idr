...
uv_timer_start :
  ...
  -> io Int32
uv_timer_start ptr f t r =
  primIO $ prim__uv_timer_start ptr (\p => toPrim $ f p) t r

||| Stop the timer, the callback will not be called anymore.
export %inline
uv_timer_stop : HasIO io => Ptr Timer -> io Int32
...
export %inline
uv_timer_again : HasIO io => Ptr Timer -> io Int32
...
export %inline
uv_timer_set_repeat : HasIO io => Ptr Timer -> Bits64 -> io ()
uv_timer_set_repeat ptr rep = primIO $ prim__uv_timer_set_repeat ptr rep

||| Get the timer repeat value.
export %inline
uv_timer_get_repeat : HasIO io => Ptr Timer -> io Bits64
...
||| uv_now.
export %inline
uv_timer_get_due_in : HasIO io => Ptr Timer -> io Bits64
